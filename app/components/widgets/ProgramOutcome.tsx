...
import outcome from "../assests/images/outcome-poster.webp"
const ProgramOutcome = () => {

const outcomePoint = ["Product Ownership","Global Marketing by Panaverse DAO","Freelacing","Boosting Economy."]

return (
<section className="mt-16 md:mt-28">
<Wrapper>
  <div className="flex gapx-8 items-center flex-col-reverse md:flex-row">
{/* Left side */}
